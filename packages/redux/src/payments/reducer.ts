...
export const entitiesMapper = {
  ...
  [actionTypes.REMOVE_PAYMENT_INTENT_INSTRUMENT_SUCCESS as typeof actionTypes.REMOVE_PAYMENT_INTENT_INSTRUMENT_SUCCESS]:
    (
      state: StoreState['entities'],
      action: AnyAction,
    ): StoreState['entities'] => {
  ...
  [actionTypes.RESET_PAYMENT_INSTRUMENTS_STATE as typeof actionTypes.RESET_PAYMENT_INSTRUMENTS_STATE]:
